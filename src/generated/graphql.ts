...
> = {
  ...
  getShipTypeFromId?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<QueryGetShipTypeFromIdArgs>
  >
  getShipsByUUID?: Resolver<
    Array<ResolversTypes["Ship"]>,
    ParentType,
    ContextType,
    Partial<QueryGetShipsByUuidArgs>
  >
  getTileByID?: Resolver<
    ResolversTypes["Tile"],
    ParentType,
    ContextType,
    Partial<QueryGetTileByIdArgs>
  >
  getTilesAroundTile?: Resolver<
    Array<ResolversTypes["Tile"]>,
    ParentType,
    ContextType,
    Partial<QueryGetTilesAroundTileArgs>
  >
  getTilesWithinRectangle?: Resolver<
    Array<ResolversTypes["Tile"]>,
    ParentType,
    ContextType,
    Partial<QueryGetTilesWithinRectangleArgs>
  >
  getUserByUsername?: Resolver<
    ResolversTypes["User"],
    ParentType,
    ContextType,
    Partial<QueryGetUserByUsernameArgs>
  >
